...
export interface MockUniswapV3FactoryInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic:
      ...
      | "PoolCreated(address,address,uint24,address)"
  ): EventFragment;
...
export namespace PoolCreated_address_address_uint24_int24_address_Event {
...
export namespace PoolCreated_address_address_uint24_address_Event {
  export type InputTuple = [
    token0: AddressLike,
    token1: AddressLike,
    fee: BigNumberish,
...
export interface MockUniswapV3Factory extends BaseContract {
  ...
  >;
  getEvent(
    key: "PoolCreated(address,address,uint24,int24,address)"
  ): TypedContractEvent<
    PoolCreated_address_address_uint24_int24_address_Event.InputTuple,
    PoolCreated_address_address_uint24_int24_address_Event.OutputTuple,
    PoolCreated_address_address_uint24_int24_address_Event.OutputObject
  >;
  getEvent(
    key: "PoolCreated(address,address,uint24,address)"
  ): TypedContractEvent<
    PoolCreated_address_address_uint24_address_Event.InputTuple,
    PoolCreated_address_address_uint24_address_Event.OutputTuple,
    PoolCreated_address_address_uint24_address_Event.OutputObject
  >;
  ...
  filters: {
    ...
    "PoolCreated(address,address,uint24,int24,address)": TypedContractEvent<
      ...
      PoolCreated_address_address_uint24_int24_address_Event.OutputObject
    >;
    "PoolCreated(address,address,uint24,address)": TypedContractEvent<
      PoolCreated_address_address_uint24_address_Event.InputTuple,
      PoolCreated_address_address_uint24_address_Event.OutputTuple,
      PoolCreated_address_address_uint24_address_Event.OutputObject
    >;
