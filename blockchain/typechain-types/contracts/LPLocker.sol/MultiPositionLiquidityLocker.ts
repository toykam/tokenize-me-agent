...
export interface MultiPositionLiquidityLockerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "PROTOCOL_ADDRESS"
      | "allTokenIds"
...
export interface MultiPositionLiquidityLocker extends BaseContract {
  connect(runner?: ContractRunner | null): MultiPositionLiquidityLocker;
  waitForDeployment(): Promise<this>;

  interface: MultiPositionLiquidityLockerInterface;
